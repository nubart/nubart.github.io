/* ============================================================
   ...
   Used by: audio-guides/monetise-museum-audio-guide.html
...
(function () {
    ...
    var eur2 = new Intl.NumberFormat('en-IE', { style: 'currency', currency: 'EUR', minimumFractionDigits: 2, maximumFractionDigits: 2 });
    var int = new Intl.NumberFormat('en-IE', { maximumFractionDigits: 0 });
    ...
    function calc() {
        ...
        var be = o('r-be');
        if (margin <= 0) {
            be.innerHTML = 'Set a selling price above the €1 card cost to make a margin.';
            return;
        }
        ...
        if (cards > 0) {
            ...
            t2 = m <= 12
                ? (' — about <b>' + int.format(Math.ceil(m)) + ' months</b> at your visitor numbers.')
                : (' — about <b>' + (Math.round(m / 12 * 10) / 10) + ' years</b> at your visitor numbers.');
        }
        be.innerHTML = 'Break-even after <b>' + int.format(beCards) + ' cards sold</b>' + t2;
    }
