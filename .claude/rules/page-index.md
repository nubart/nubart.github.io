# Nubart Website — Page Index & URL Map
...
- DE: de/kunden/index.html
- ES: es/clientes-proyectos.html
- FR: fr/nubart-clients-projets.html
- IT: it/nubart-progetti-clienti.html
- NL: nl/klanten-projecten.html
- JA: ja/audio-guides/customers/index.html
- BG: bg/klienti.html
- PL: pl/klienci/index.html
...
### Accessible Digital Audio Guides for Museums
...
- DE (Austrian leads): de/simultan-uebersetzung-ki/nubart-translate-testkit-oes.html
...
**Transcription request (unlinked post-event form):**
...
- (no translated versions; linked from the secondary navbar "Instructions" button on all five SYNC landing pages — EN, DE, ES, FR, IT — all pointing to this same EN-only page)
...
- (no translated versions; linked from the "Not using BrightSign?" note at the bottom of page 1 of `sync/nubart-sync-brightsign-instructions.html`)
